...
print("----------------------------")
# fix decimals
print(f"Khan: {round((len(khanIds)/len(idsSet))*100)}% ({len(khanIds)})")
print(f"Correy: {round((len(correyIds)/len(idsSet))*100)}% ({len(correyIds)})")
print(f"Li: {round((len(liIds)/len(idsSet))*100)}% ({len(liIds)})")
print(f"O'Tooley: {round((len(otoolIds)/len(idsSet))*100)}% ({len(otoolIds)})")
print("----------------------------")
